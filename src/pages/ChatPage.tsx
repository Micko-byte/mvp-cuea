                    ...
                    >
                      ...
                      {profile.program && (
                        <p className="text-xs text-sidebar-foreground/50 px-2">
                          {profile.program} • Year {profile.year} • Sem {profile.semester}
                        </p>
                      )}
                    </motion.div>
                  )}
                ...
                <div className="grid grid-cols-2 gap-3">
                  {SUGGESTIONS.map((s, i) => (
                    <motion.button
                      ...
                      className="p-4 rounded-xl border border-border bg-card hover:shadow-card hover:-translate-y-0.5 transition-all text-left"
                    >
              ...
              {activeChat.messages.map((msg) => (
                ...
                >
                  <div className="flex flex-col gap-1 max-w-[85%]">
                    <div
                      className={`px-4 py-3 rounded-2xl text-sm leading-relaxed ${msg.sender === "user" ? "bg-gradient-maroon text-primary-foreground rounded-br-md" : "bg-muted text-foreground rounded-bl-md"}`}
                    >
                      {msg.sender === "bot" && (
                ...
                {attachedFiles.length > 0 && (
                  <div className="flex flex-wrap gap-1.5 mb-2">
                    {attachedFiles.map((file, i) => (
                      <span
                        key={i}
                        className="inline-flex items-center gap-1 text-xs bg-muted px-2 py-1 rounded-lg border border-border"
                      >
