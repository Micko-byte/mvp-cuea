      ...
      <div className="max-w-3xl mx-auto p-6 space-y-10 text-foreground">
        ...
        <section>
          ...
          <div className="space-y-4 text-sm leading-relaxed">
            <p>I'm <strong>Sekani</strong>, an academic AI assistant.</p>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                ...
                <li>Sekani does not store or redistribute copyrighted material from universities or official exams.</li>
                <li>AI answers are transformative: they summarize, explain, or analyze notes rather than reproduce them verbatim.</li>
                <li>Sekani is <strong>not</strong> officially affiliated with or endorsed by any university.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-6 text-sm leading-relaxed">
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                <li>Sekani is an AI study assistant built to help students learn using student-contributed notes.</li>
                <li>You may only use the platform for educational purposes.</li>
                <li>All AI responses are based on notes uploaded by students. Sekani does not provide official university material.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                ...
                <li>Sekani does not review uploaded content for copyright. You are solely responsible for anything you upload.</li>
                <li>You grant Sekani a license to store and process your content for AI training and study functionality. This license is limited, non-exclusive, and revocable if content is removed.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                <li>Sekani owns the platform, the AI, and all related software and branding.</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                <li>Sekani provides educational assistance "as-is".</li>
                <li>We do not guarantee accuracy of AI responses.</li>
                <li>Sekani is not responsible for any academic consequences arising from using the platform.</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                ...
                <li>Sekani reserves the right to remove content that violates these terms.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                ...
                <li>Sekani reserves the right to adjust pricing or limits at any time with notice.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                ...
                <li>Sekani may modify these terms at any time; continued use constitutes acceptance.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-6 text-sm leading-relaxed">
            <div>
              ...
              <p>Sekani ("we", "our", "us") is an AI-powered learning platform that allows users to upload academic materials, interact with AI, and access educational features. By using Sekani, you agree to this Privacy Policy.</p>
            </div>
            ...
            <div>
              ...
              <p>Users retain ownership of their uploaded content. By uploading, users grant Sekani a limited, non-exclusive license to store, process, and generate embeddings for AI functionality. Uploaded documents are used strictly for educational purposes.</p>
            </div>
